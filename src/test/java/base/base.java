...
import pages.OpenFormPOM;
import pages.EnrollNowPOM;
...
public class base {
	...
	protected HeaderElement headerExtent;
	protected RandomDetails random;
	protected WebDriverWait wait;
	protected OpenFormPOM Openform;
	protected SoftAssert softAssert;
	protected JavascriptExecutor js;
	protected EnrollNowPOM enrollnow;
	...
	protected LandingPagesPOM lppages;
	...
	public void LaunchBrowser() {
		...
		// driver.navigate().to("https://qa-fe.amityonline.com");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(7));
		Openform = new OpenFormPOM(driver);
		random=new RandomDetails(driver);
		softAssert = new SoftAssert(); // ✅ SoftAssert instance
		wait=new WebDriverWait(driver, Duration.ofSeconds(20));
		js=((JavascriptExecutor)driver);
		enrollnow = new EnrollNowPOM(driver);
		...
		lppages = new LandingPagesPOM(driver);
	}	
