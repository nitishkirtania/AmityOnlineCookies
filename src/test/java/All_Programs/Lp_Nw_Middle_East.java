...
public class Lp_Nw_Middle_East extends base {

    @BeforeMethod(alwaysRun = true)
            public void redirectToLp_Nw_MiddleEast() throws InterruptedException {
                driver.get("https://qa-fe.amityonline.com/lp-nw/middle-east");
                Thread.sleep(2000);
            }

    @Test(priority = 1)
    public void Enquire_Now_India() throws Exception {
        test = reports.createTest("Enquire Now Open Form India (Lp Nw-Middle East)");
        ...
        try {
            ...
            Lp_Nw_Middle_East.validateLeadSummaryData(lead, randomEmail, randomName, randomMobileNumber, expectedURL, expectedProgram, expectedSpecialization, lsqId, cleanVisited, Enquirysource, utm_medium, softAssert);
            Thread.sleep(5000);
    ...
    public void Enquire_Now_International() throws Exception {
        test = reports.createTest("Enquire Now Open Form International(Lp Nw-Middle East)");
        closescholarshippopup();
        closePopupIfPresent();
        String expectedURL = "";
        String expectedProgram = "MASTER OF COMPUTER APPLICATIONS";
        ...
        js.executeScript("arguments[0].click();", hPom.lp_nw_enquireNow_Element);
        test.log(Status.PASS, "Enquire Now button clicked");
        WebElement country_code = driver.findElement(By.xpath("//select[@id='phone_no']"));
        country_code.click();
        WebElement uae_county = driver.findElement(By.xpath("//option[@value='+971']"));
        uae_county.click();
        Thread.sleep(1000);
        String randomMobileNumber = "233" + random.getRandomMobileNumber();
        String randomName = "TestQA " + random.GetRandomName();
        ...
        try {
            ...
            // Thread.sleep(1000);
            String ApplicationUrl = null;
            Cookie appCookie = waitForCookie("ApplicationUrl", 8, 6000);
            if (appCookie != null) {
                String decodedAppUrl = URLDecoder.decode(appCookie.getValue(), StandardCharsets.UTF_8);
                ApplicationUrl = decodedAppUrl.replace("/lander", "/DashBoard");
                test.info("✅ Final Application URL Cookie: " + ApplicationUrl);
    ...
    public void yellow_strip() throws Exception {
        test = reports.createTest("Yellow Strip CTA (LP-Middle East)");
        closescholarshippopup();
        closePopupIfPresent();
     ...
     @Test(priority = 4)
    public void yellow_strip_International() throws Exception {
        test = reports.createTest("Yellow Strip CTA International (LP-Middle East)");
        closescholarshippopup();
        closePopupIfPresent();
        String expectedURL = "https://qa-fe.amityonline.com/";
        String expectedProgram = "BACHELOR OF BUSINESS ADMINISTRATION";
        ...
        try {
            ...
            Thread.sleep(2000);
            WebElement country_field= driver.findElement(By.xpath("//body/div[@id='_modal']/div[@class='Modal_root__5nZXA']/div/div[@class='bg-white Modal_dialog__e3Pgf']/div[contains(@class,'LandingPageConnectModalTempleteOne_root__qDa2y relative flex w-full outline-none focus:outline-none')]/div[@class='LandingPageConnectModalTempleteOne_formSection___DqW_']/div[@class='mx-auto xl:pl-0 w-full']/div/form[@class='LandingPageConnectModalFormTempleteOne_root__0HQXJ']/div[@class='LandingPageConnectModalFormTempleteOne_inputWrapper__O4lCP flex gap-4']/div[1]"));
            country_field.click();
            WebElement uae_select = driver.findElement(By.xpath("(//option[@value='+971'][normalize-space()='+971'])[2]"));
            uae_select.click();
            String randomMobileNumber = "231" + random.getRandomMobileNumber();
            String randomName = "TestQA" + " " + random.GetRandomName();
            String randomEmail = "TestQA_" + random.GetRamdonEmailID() + "@gmail.com";
	...
	public void ApplyNow_BlueRFI_India() throws InterruptedException {
		test=reports.createTest("Apply Now_BlueCart India (LP- Middle East)");
		closescholarshippopup();
        closePopupIfPresent();
        String expectedURL = "";
        String expectedProgram = "MASTER OF COMPUTER APPLICATIONS";
