...
public class Lp_Nw_MiddleEast_MCA extends base {


    @BeforeMethod(alwaysRun = true)
            public void redirectToLp_Nw_MiddleEast_MBA() throws InterruptedException {
                driver.get("https://qa-fe.amityonline.com/lp-nw/middle-east/mca");
                Thread.sleep(2000);
            }
    ...
    public void Enquire_Now_India() throws Exception {
        ...
        js.executeScript("arguments[0].click();", hPom.enquireNow_MiddleEast);
        ...
        try {
            ...
            Lp_Nw_MiddleEast_MCA.validateLeadSummaryData(lead, randomEmail, randomName, randomMobileNumber, expectedURL, expectedProgram, expectedSpecialization, lsqId, cleanVisited, Enquirysource, utm_medium, softAssert);
            Thread.sleep(5000);
    ...
    public void Enquire_Now_International() throws Exception {
        test = reports.createTest("Enquire Now Open Form International (Lp Nw-Middle East MBA)");
        // closescholarshippopup();
        // closePopupIfPresent();
        String expectedURL = "";
        String expectedProgram = "MASTER OF COMPUTER APPLICATIONS";
        ...
        WebElement country_field = driver.findElement(By.xpath("//select[@id='countryCode']"));
        country_field.click();
        WebElement uae_select = driver.findElement(By.xpath("//option[@value='+971']"));
        uae_select.click();
    ...
    @Test(priority = 3)
    public void yellow_strip_India() throws Exception {
        test = reports.createTest("Yellow Strip CTA India (Landing Pages)");
        closescholarshippopup();
        closePopupIfPresent();
    ...
    public void yellow_strip_International() throws Exception {
        ...
        try {
            ...
            test.info("Random Email: " + randomEmail);
            test.info("Random Mobile Number: " + randomMobileNumber);
            WebElement country_field = driver.findElement(By.xpath("(//select[@id='countryCode'])[2]"));
            country_field.click();
    ...
    public void Download_Brochure_India() throws Exception {
        ...
        WebElement download_brocher = driver.findElement(By.xpath("//span[normalize-space()='Download Brochure']"));
        download_brocher.click();
        ...
        try {
            ...
            Lp_Nw_MiddleEast_MCA.validateLeadSummaryData(
    ...
    public void Download_Brochure_International() throws Exception {
        ...
        try {
            ...
            // dbrochure.selectdropdown();
            WebElement countryDropdown = driver.findElement(By.xpath("//select[@name='countryCode']"));
