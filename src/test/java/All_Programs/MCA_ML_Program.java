...
public class MCA_ML_Program extends base {

    @BeforeMethod(alwaysRun = true)
    public void redirectToBBA() throws InterruptedException {
        driver.get("https://qa-fe.amityonline.com/mca-machine-learning-online");
        Thread.sleep(2000);
    }
    ...
    public void verifyEnquireNowHeader_India() throws InterruptedException {
        ...
        try {
            ...
            MCA_ML_Program.validateLeadSummaryData(lead, randomEmail, randomName, randomMobileNumber, expectedURL,
            ...
            WebElement continueapplication = wait
            ...
            try {
                WebElement isSuccess = wait
                        .until(ExpectedConditions.elementToBeClickable(enquirNow.startapplicationElement));
    ...
    public void verifyInstantScholarshipTest() {
        ...
        try {
            ...
            // if (hPom.yellowstripcontentElement.getText().equalsIgnoreCase("Reserve Your
            // Spot Now")) {
        ...
        try {
            ...
            MCA_ML_Program.validateLeadSummaryData(
    ...
    public static void validateLeadSummaryData(LeadSummary lead,
        ...
        // softAssert.fail("❌ Program name mismatch LS : expected '" + expectedProgram +
        // "', actual '" + lead.programName + "'");
        // test.log(Status.FAIL, "❌ Program name mismatch LS : expected '" +
        // expectedProgram + "', actual '" + lead.programName + "'");
        // } else {
        // test.log(Status.PASS, "✅ Program name matched LS : " + lead.programName);
        // }

        // // ✅ Specialization Name check with null/blank handling
        // String expected = expectedSpecialization != null ?
        // expectedSpecialization.trim() : "";
        ...
        // softAssert.fail("❌ Specialization mismatch LS: expected empty, actual '" +
        // actual + "'");
        // test.log(Status.FAIL, "❌ Specialization mismatch LS: expected empty, actual
        // '" + actual + "'");
        // } else if (actual.isEmpty()) {
        // // Actual is blank, expected is not
        // softAssert.fail("❌ Specialization mismatch LS: expected '" + expected + "',
        // actual empty");
        // test.log(Status.FAIL, "❌ Specialization mismatch LS: expected '" + expected +
        // "', actual empty");
