...
public class BBA_Program extends base {

    @BeforeMethod(alwaysRun = true)
	public void redirectToBBA() throws InterruptedException {
		driver.get("https://qa-fe.amityonline.com/bachelor-of-business-administration-online");
		Thread.sleep(2000);
	}
	...
	public void verifyEnquireNowHeader_India() throws InterruptedException {
	    ...
	    try {
            ...
            BBA_Program.validateLeadSummaryData(lead, randomEmail, randomName, randomMobileNumber, expectedURL, expectedProgram, expectedSpecialization, lsqId, cleanVisited, Enquirysource, utm_medium, softAssert);
	...
	public void verifyApplyNowHeader_India() throws Exception {
		...
		try {
			String originalWindow = driver.getWindowHandle();
            WebElement Apply_now_btn = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[contains(@class,'header-opt_applyBtnWrapper__NmhC_')]//span[contains(@class,'ClientSideButton_btnText__5gMgu')][normalize-space()='APPLY NOW']")));
            ...
            String lsqId = null;
            Cookie lsqCookie = waitForCookie("LSQ_ID2", 5, 5000); // 5 retries, 1 second apart
            if (lsqCookie != null) {
                lsqId = lsqCookie.getValue();
                test.info("✅ LSQ_ID2 Cookie: " + lsqId);
            } else {
    ...
    try {
        ...
        BBA_Program.validateLeadSummaryData(
...
@Test(priority = 6)
    ...
    public void Open_form_BBA_International() throws InterruptedException {
        ...
        try {
            ...
            wait.until(ExpectedConditions.elementToBeClickable(Openform.name));
            Openform.name.sendKeys(randomName);
            WebElement click_COuntry = driver.findElement(By.xpath("//div[@class='CustomDropdownGlobal_countryCode__yswjf ']"));
            click_COuntry.click();
            Actions codeActions1 = new Actions(driver);
            WebElement unitedstate = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[@class='CustomDropdownGlobal_dropdownMenu__cyPE8']//div[2]//span[1]")));
    ...
    public void Download_Brochure_International() throws Exception {
        ...
        try {
           ...
           WebElement codeDropdown = driver.findElement(By.xpath("//div[@class='flex gap-2']//div//div[contains(@class,'CustomDropdownGlobal_countryCode__yswjf')][normalize-space()='IN +91']"));
            ...
            String decodedVisited = null;
            String cleanVisited = null;
            Cookie visitedURLsCookie = waitForCookie("VisitedURLs", 5, 1000);
